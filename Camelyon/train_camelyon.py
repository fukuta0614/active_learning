...
from camelyon_utils import CamelyonDataset, dataset_path
from train_utils import make_optimizer, progress_report, evaluate

import logger

sys.path.append(os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), 'shared'))
from models import MODEL_PATH, TrainableCNN, BilinearCNN
...
def main():
    ...
    train = CamelyonDataset(train_data,
                            original_size=image_size, crop_size=crop_size, aug=True, color_aug=args.color_aug,
    ...
    if args.new:
        ...
        if args.finetune:
            model.load_pretrained(os.path.join(MODEL_PATH, init_path[args.arch]), num_class)
        else:
